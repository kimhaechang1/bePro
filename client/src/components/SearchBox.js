...
const SearchBox = (props) =>{
    ...
    return(
        <>
        <input type="text" value={props.forValue} onChange={(e)=>{props.forsetValue(e.target.value)}}/>
                <svg onClick={onClickHandler} style={{cursor:"pointer"}} version="1.0" xmlns="http://www.w3.org/2000/svg" width="17px" height="17px" viewBox="0 0 1244.000000 1280.000000"preserveAspectRatio="xMidYMid meet">
